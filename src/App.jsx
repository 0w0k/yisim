              ...
              >
                <Flex justify="space-between"  vertical gap={16}>
                  <Space className="bg" direction="vertical" size={16}>
                    <Space wrap size={16}>
                      <Avatar size={80} src='yisim/YiXian-IconsAndNames\characters\mu-yifeng.png' />
                      <Avatar size={64} src='yisim/dunwu.png' />
                      <Avatar size={64} src='yisim/dunwu.png' />
                      <Avatar size={64} src='yisim/dunwu.png' />
                      <Avatar size={64} src='yisim/dunwu.png' />
                      <Avatar size={64} icon={<img style={{ objectFit: 'contain' }} src='yisim/YiXian-IconsAndNames\jobs\elixirist.png' />} />
                              ...
                              fields.map((field, i) => {
                                return (
                                  <Space key={`a-cards-${i}`} direction="vertical" >
                                    <Avatar className="card" shape="square" src={`yisim/yxp_images/en/${a?.cards[i].card_id + a?.cards[i].level - 1}.png`} />
                    ...
                    <Text >[ Hand Card ]</Text>
                    <Space size={16}>
                      <Avatar className="card" shape="square" src='yisim/yxp_images\en\111011.png' />
                      <Avatar className="card" shape="square" src='yisim/yxp_images\en\111011.png' />
                      <Avatar className="card" shape="square" src='yisim/yxp_images\en\111011.png' />
                      <Avatar className="card" shape="square" src='yisim/yxp_images\en\111011.png' />
                      <Avatar className="card" shape="square" src='yisim/yxp_images\en\111011.png' />
                  ...
                  <Space className="bg" direction="vertical" size={16}>
                    <Space wrap size={16}>
                      <Avatar size={80} src='yisim/YiXian-IconsAndNames/characters/du-lingyuan.png' />
                      <Avatar size={64} src='yisim/dunwu.png' />
                      <Avatar size={64} src='yisim/dunwu.png' />
                      <Avatar size={64} src='yisim/dunwu.png' />
                      <Avatar size={64} src='yisim/dunwu.png' />
                      <Avatar size={64} icon={<img style={{ objectFit: 'contain' }} src='yisim/YiXian-IconsAndNames\jobs\formation-master.png' />} />
                          ...
                          (fields, { add, remove },) => {
                            return (
                              fields.map((field, i) => {
                                return (
                                  <Space key={`a-cards-${i}`} direction="vertical" >
                                    <Avatar className="card" shape="square" src={`yisim/yxp_images/en/${b?.cards[i].card_id + b?.cards[i].level - 1}.png`} />
                                    <Form.Item name={[field.name, 'card_id']} className="cardname">
                                      <Select
                                        showSearch
                                        placeholder="Select a Card"
